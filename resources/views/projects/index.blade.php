          ...
          <table class="table table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>Name</th> <th>Description</th> <th>Subscriber_coun

Exit
Exit
1
Exit
 Php Artisan Make</th> <th>Description</th> <th>Subscriber_coun</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$project->name}}</td> <td>{{$project->description}}</td> <td>{{$project->subscriber_coun

exit
exit
1
exit
 php artisan make}}</td> <td>{{$project->description}}</td> <td>{{$project->subscriber_coun}}</td>
